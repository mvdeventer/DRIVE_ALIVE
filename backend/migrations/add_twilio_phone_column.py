"""
Migration script to add twilio_phone_number column to users table
"""
...
def run_migration():
    """Add twilio_phone_number column to users table"""
    ...
    try:
        ...
        if "twilio_phone_number" in columns:
            print("Column 'twilio_phone_number' already exists in users table")
            conn.close()
            return
        ...
        conn.commit()
        print("✅ Successfully added 'twilio_phone_number' column to users table")

...
This guide upgrades an existing installation to Drive Alive 6.6.0.
...
- Review `docs/releases/v6.6.0.md` for the repository copy of the published release notes.

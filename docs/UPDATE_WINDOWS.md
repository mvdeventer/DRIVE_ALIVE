...
This guide upgrades an existing installation to Drive Alive 7.2.0.
...
- Review `docs/releases/v7.2.0.md` for the repository copy of the published release notes.
